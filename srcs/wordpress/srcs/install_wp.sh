...
then
wp-cli core install --url=192.168.99.180:5050 --title=Magie --admin_user=root --admin_password=1234 --admin_email=corentinfrancois31@gmail.com --path=/usr/share/nginx/html/wordpress
